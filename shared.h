...
inline constexpr wchar_t TapClass[] = L"LiteTaskbar.Tap.2026";
...
inline constexpr CLSID TapClsid = {0xf33b8e61,0xf180,0x40f4,{0x93,0x77,0x45,0x5b,0xbb,0xce,0x67,0xa1}};
